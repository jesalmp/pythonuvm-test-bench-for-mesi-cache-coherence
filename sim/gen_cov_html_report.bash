...
/opt/coe/cadence/VMANAGER/bin/imc -execcmd "merge * -out ALL;
              ...
              report -html -overwrite -out cov_work/report_cov_multicore -detail -metrics all -all;
              report -text -out cov_work/report_cov_multicore/summary.txt -summary -metrics all -all"
