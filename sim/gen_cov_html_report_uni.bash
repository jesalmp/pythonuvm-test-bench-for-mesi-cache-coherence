...
/opt/coe/cadence/VMANAGER/bin/imc -execcmd "merge * -out ALL;
              ...
              report -html -overwrite -out cov_work/report_cov_unicore -detail -metrics all -all;
              report -text -out cov_work/report_cov_unicore/summary.txt -summary -metrics all -all"
              #report_metrics -out report_cov_unicore -detail -metrics all:block:expression"
