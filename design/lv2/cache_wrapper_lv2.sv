...
module cache_wrapper_lv2 #(
    ...
    assign clk = pclk;
    wire lv2_wr;
    assign lv2_wr = psel & pwrite;
    wire lv2_rd;
    assign lv2_rd = psel & !pwrite;
    wire cp_in_cache;
    assign cp_in_cache = 1'b0;
    wire [ADDR_WID - 1 : 0] addr_bus_lv1_lv2;
    assign addr_bus_lv1_lv2 = paddr;
    wire [DATA_WID - 1 : 0] data_bus_lv1_lv2;
    assign data_bus_lv1_lv2 = lv2_wr ? pwdata : prdata;
    wire data_in_bus_lv1_lv2;
    wire lv2_wr_done;
    assign pready = (data_in_bus_lv1_lv2 === 1'b1) | lv2_wr_done;
    assign prdata = (data_in_bus_lv1_lv2 === 1'b1) ? data_bus_lv1_lv2 : 32'hz;
