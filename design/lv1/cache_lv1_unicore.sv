...
module cache_lv1_unicore #(
    ...
    assign clk = pclk;
    wire cpu_wr;
    assign cpu_wr = psel & pwrite;
    wire cpu_rd;
    assign cpu_rd = psel & !pwrite;
    wire [ADDR_WID - 1 : 0] addr_bus_cpu_lv1;
    assign addr_bus_cpu_lv1 = paddr;
    ...
    wire cpu_wr_done;
    assign pready = data_in_bus_cpu_lv1 | cpu_wr_done;

    wire [DATA_WID - 1 : 0] data_bus_cpu_lv1;
    assign data_bus_cpu_lv1 = cpu_wr ? pwdata : prdata;
    assign prdata = data_in_bus_cpu_lv1 ? data_bus_cpu_lv1 : 32'hz;
