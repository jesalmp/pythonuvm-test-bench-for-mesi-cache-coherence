...
module cache_lv1_dualcore #(
    ...
    assign lv2_rd                = lv2_rd_uni[0] | lv2_rd_uni[1];
    assign lv2_wr                = lv2_wr_uni[0] | lv2_wr_uni[1];
    assign shared                = shared_local[0] | shared_local[1];
    assign all_invalidation_done = (invalidation_done[0] | bus_lv1_lv2_gnt_proc[0]) & (invalidation_done[1] | bus_lv1_lv2_gnt_proc[1]);
    assign cp_in_cache           = cp_in_cache_uni[0] | cp_in_cache_uni[1];
