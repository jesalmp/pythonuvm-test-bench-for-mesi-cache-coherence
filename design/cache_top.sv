...
module cache_top # (
    ...
    wire                          pslverr             ;
    wire                          pready              ;
    wire [ADDR_WID_LV1 - 1 : 0]   paddr               ;
    wire [DATA_WID_LV1 - 1 : 0]   pwdata              ;
    reg  [DATA_WID_LV1 - 1 : 0]   prdata              ;

    assign pclk                = clk;
    assign presetn             = resetn;
    assign paddr               = addr_bus_lv1_lv2;
    assign psel                = (lv2_rd & lv2_rd_ps & !cp_in_cache) | lv2_wr;
    assign penable             = (lv2_rd & lv2_rd_pe & !cp_in_cacheen) | (lv2_wren & lv2_wr);
    assign pwrite              = lv2_wr;
    assign pwdata              = lv2_wr ? data_bus_lv1_lv2 : 32'hz;
    assign lv2_wr_done         = pready & lv2_wren;
    assign data_in_bus_lv1_lv2 = (pready & bus_lv1_lv2_gnt_lv2) ? 1'b1 : 1'bz;
    assign data_bus_lv1_lv2    = (data_in_bus_lv1_lv2 === 1'b1) ? prdata : 32'hz;
